...
// MARK: - C bindings (curve25519-donna + curve_sigs, vendored from christophhagen/CCurve25519, MIT)
// Declaradas con @_silgen_name para compilar en el target de la app sin módulo C.

@_silgen_name("curve25519_donna")
private func curve25519_donna(_ out: UnsafeMutablePointer<UInt8>?, _ k: UnsafePointer<UInt8>?, _ basepoint: UnsafePointer<UInt8>?) -> Int32

@_silgen_name("curve25519_sign")
private func curve25519_sign(_ signatureOut: UnsafeMutablePointer<UInt8>?, _ privkey: UnsafePointer<UInt8>?, _ msg: UnsafePointer<UInt8>?, _ msgLen: UInt, _ random: UnsafePointer<UInt8>?) -> Int32

@_silgen_name("curve25519_verify")
private func curve25519_verify(_ signature: UnsafePointer<UInt8>?, _ pubkey: UnsafePointer<UInt8>?, _ msg: UnsafePointer<UInt8>?, _ msgLen: UInt) -> Int32

@_silgen_name("generalized_xveddsa_25519_sign")
private func generalized_xveddsa_25519_sign(_ signatureOut: UnsafeMutablePointer<UInt8>?, _ x25519PrivkeyScalar: UnsafePointer<UInt8>?, _ msg: UnsafePointer<UInt8>?, _ msgLen: UInt, _ random: UnsafePointer<UInt8>?, _ customizationLabel: UnsafePointer<UInt8>?, _ customizationLabelLen: UInt) -> Int32

@_silgen_name("generalized_xveddsa_25519_verify")
private func generalized_xveddsa_25519_verify(_ vrfOut: UnsafeMutablePointer<UInt8>?, _ signature: UnsafePointer<UInt8>?, _ x25519PubkeyBytes: UnsafePointer<UInt8>?, _ msg: UnsafePointer<UInt8>?, _ msgLen: UInt, _ customizationLabel: UnsafePointer<UInt8>?, _ customizationLabelLen: UInt) -> Int32
